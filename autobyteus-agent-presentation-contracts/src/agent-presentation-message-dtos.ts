...
const variants = Object.entries(agentPresentationPayloadSchemas).map(([type, payload]) =>
  z.object({ type: z.literal(type), payload }).strict());
export const agentPresentationMessageSchema: z.ZodType<AgentPresentationMessage> = z.union([
  ...variants,
  z.object({ type: z.literal("ERROR"), payload: agentPresentationErrorPayloadSchema }).strict(),
] as unknown as [z.ZodTypeAny, z.ZodTypeAny, ...z.ZodTypeAny[]]) as z.ZodType<AgentPresentationMessage>;
