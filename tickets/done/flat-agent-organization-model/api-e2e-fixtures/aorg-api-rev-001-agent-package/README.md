# AORG API-REV-001 Real-User Agent Package

This deterministic local-path package is the retained input for the
`AORG-FLAT-TEAM-001` API/E2E run. It is intentionally imported through the
