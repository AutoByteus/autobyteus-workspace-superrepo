# AORG-FLAT-TEAM-001 Real-System Test Manifest

This is the retained executable plan for the first completed API/E2E result,
`API-REV-001`. The earlier browser attempt stopped after exposing the raw
AgentOrg dashboard defect; it was not a completed result. This revision tests
the cumulative `AD-REV-006` / `IR-008` / `CRR-008` package.
