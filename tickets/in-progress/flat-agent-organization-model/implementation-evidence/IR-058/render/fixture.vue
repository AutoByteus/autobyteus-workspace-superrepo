...
const tree = useWorkspaceHistoryTreeState({ runHistoryStore: history, selectionStore: useAgentSelectionStore(), selectedAgentOrg: computed(() => { const org = orgs.contextFor('org-run'); return { rootRunId: 'org-run', focusAddress: org?.selectedAddress ?? null, selection: org?.selection ?? null } }) })
const state = {
