...
| --- | --- | --- | --- | --- | --- |
| ASM-001 | Assumption | The user's main goal is a simpler, fixed-depth composition model rather than distributed orchestration across separately running Teams. | The latter is structurally more complex and contradicts the stated simplification goal. | Included in latest `RER-004` approval basis. | Proposed for approval |
