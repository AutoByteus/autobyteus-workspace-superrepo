import { z } from "zod";
import { agentPresentationErrorPayloadSchemas, agentPresentationPayloadSchemas, nonEmptyStringSchema, } from "@autobyteus/agent-presentation-contracts";
...
const withExecution = (schema) => schema.extend(execution).strict();
